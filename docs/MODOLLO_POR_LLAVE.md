...
- **Otras tareas (variantes, ajustes, etc.):** muchas llamadas al día → usa un modelo con **RPD alto** (p. ej. `moonshotai/kimi-k2-instruct`: 1000 RPD, 60 RPM).
...
- **Llaves 2 y 3** para el resto (variantes, etc.):
  - `GROQ_MODEL_2=moonshotai/kimi-k2-instruct`
  - `GROQ_MODEL_3=moonshotai/kimi-k2-instruct`  
